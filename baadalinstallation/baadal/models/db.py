...
db.define_table('template',
    ...
    Field('os_type', default = "Linux", requires = IS_IN_SET(('Linux', 'Others')), label='Harddisk(GB)'),
    Field('arch', default = "amd64", requires = IS_IN_SET(('amd64', 'i386')), label='Operating System'),
    Field('hdd', 'integer', notnull = True, label='Architecture'),
