...
def get_edit_pending_request_form(request_id):
    ...
    if edit_req.request_type in (TASK_TYPE_CREATE_VM, TASK_TYPE_EDITCONFIG_VM) :
    ...
    elif edit_req.request_type == TASK_TYPE_CLONE_VM:
        form_fields.append('clone_count')
    
    elif edit_req.request_type == TASK_TYPE_ATTACH_DISK:
