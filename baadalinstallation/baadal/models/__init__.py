...
__all__ =['enqueue_vm_request','get_mail_admin_form','send_email_to_admin','get_performance_graph','send_email_to_faculty','get_all_pending_requests',
            ...
            'get_my_pending_vm','get_my_hosted_vm','get_hosted_vm_list','get_pending_request_list','reject_vm_request', 'get_pending_requests',
            ...
            'get_request_info','get_request_status','get_segregated_requests','updte_host_status','delete_host_from_db']
