...
Normal_pkg_lst=(git zip unzip tar openssh-server build-essential python2.7:python2.5 netperf sysbench sysstat python-dev python-paramiko libapache2-mod-wsgi debconf-utils wget libapache2-mod-gnutls python-matplotlib python-reportlab inetutils-inetd tftpd-hpa dhcp3-server apache2 apt-mirror python-rrdtool python-lxml libnl-dev libxml2-dev libgnutls-dev libdevmapper-dev libcurl4-gnutls-dev libyajl-dev libpciaccess-dev nfs-common qemu-utils python-simplejson uuid-dev websockify)

Ldap_pkg_lst=(python-ldap perl-modules libpam-krb5 libpam-cracklib php5 libnss-ldap krb5-user ldap-utils libldap-2.4-2 nscd ca-certificates ldap-auth-client krb5-config libkrb5-dev ntpdate)
