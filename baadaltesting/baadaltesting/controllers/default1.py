...
def system_testing():
    ...
    form = FORM(  TABLE
        (  
           TR(INPUT(_name='testcase1', _type='checkbox', _value="1"),'Migrate'),
           TR(INPUT(_name='testcase2', _type='checkbox', _value="2"),'Shutdown'),
           TR(INPUT(_name='testcase3', _type='checkbox', _value="3"),'Paused'),
           TR(INPUT(_name='testcase4', _type='checkbox', _value="4"),'Delete'),
           TR(INPUT(_name='testcase5', _type='checkbox', _value="5"),'Force Shutdown'),
           TR(INPUT(_name='testcase6', _type='checkbox', _value="6"),'Attach Disk'),
           TR(INPUT(_name='testcase7', _type='checkbox', _value="7"),'Baadal Shutdown'),
           TR(INPUT(_name='testcase8', _type='checkbox', _value="8"),'Clone VM'),
           TR(INPUT(_name='testcase9', _type='checkbox', _value="9"),'Edit VM Configuration'),
           TR(INPUT(_name='testcase10', _type='checkbox', _value="10"),'VNC Access'),
           TR(INPUT(_name='testcase11', _type='checkbox', _value="11"),'Sanity Check'),
    ...
    try:
        ...
        form = FORM( TABLE
                  (  TR(INPUT(_name='testcase1', _type='radio', _value="1"),'Unit Testing'),
                     ...
                     TR(INPUT(_name='testcase4', _type='radio', _value="5"),'System Testing'),                    
                     BR(),
                     TR(INPUT(_type='submit',_value='submit'))
                  )
                )        
