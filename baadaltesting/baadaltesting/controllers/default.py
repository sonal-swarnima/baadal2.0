	...
	import commands
        ...
        if form.process().accepted:
            if request.vars['testcase1']!=None: 
                ...
                redirect(URL(r=request, f='main_server',vars=dict(email_id=email_id,user_name=user_name,ip_addr=ip_addr,server_name=server_name['10.237.20.155'])))
...
def unit_testing():
    ...
    test_list={'54':'All','1':'Login','2':'Configure System: Add Host','3':'Configure System: Add Template','4':'Configure System: Add Datastore','5':'Configure System:Add Security Domain','6':'Request VM'}   
    if form.process().accepted:
        testcase_list=[]
        test_case_list=[]
        j=0
...
def integration_testing(): 
    ...
    form = FORM(  TABLE
                  ...
                  (    TR(INPUT(_name='testcase93', _type='checkbox', _value="93"),'Maintain Idompotency'),
                       ...
                       TR(INPUT(_name='testcase101', _type='checkbox', _value="101"),'Performance Testing(1CPU,80GB HDD,256MB RAM)'),
			TR(INPUT(_name='testcase102', _type='checkbox', _value="102"),'Performance Testing(1CPU,80GB HDD,512MB RAM)'),
			TR(INPUT(_name='testcase103', _type='checkbox', _value="103"),'Performance Testing(1CPU,80GB HDD,1GB RAM)'),
			TR(INPUT(_name='testcase104', _type='checkbox', _value="104"),'Performance Testing(1CPU,80GB HDD,2GB RAM)'),
			TR(INPUT(_name='testcase105', _type='checkbox', _value="105"),'Performance Testing(2CPU,80GB HDD,2GB RAM)'),
			TR(INPUT(_name='testcase106', _type='checkbox', _value="106"),'Performance Testing(2CPU,80GB HDD,4GB RAM)'),
			TR(INPUT(_name='testcase107', _type='checkbox', _value="107"),'Performance Testing(4CPU,80GB HDD,4GB RAM)'),
			TR(INPUT(_name='testcase108', _type='checkbox', _value="108"),'Performance Testing(4CPU,80GB HDD,8GB RAM)'),
			TR(INPUT(_name='testcase109', _type='checkbox', _value="109"),'Performance Testing(8CPU,80GB HDD,8GB RAM)'),
			TR(INPUT(_name='testcase110', _type='checkbox', _value="110"),'Performance Testing(8CPU,80GB HDD,16GB RAM)'),
			TR(INPUT(_name='testcase111', _type='checkbox', _value="111"),'Performance Testing(16CPU,80GB HDD,16GB RAM)'),
			TR(INPUT(_name='testcase112', _type='checkbox', _value="112"),'Performance Testing(1CPU,100GB HDD,256MB RAM)'),
#                             
    ...
    test_list={'93':'Maintain Idompotency','95':'VM Performance(Memory)','96':'VM Performance(CPU)','97':'VM Performance(Network)','98':'VM Performance(Disk)','99':'VM Performance   (Shutdown )','56':'User Request VM(Approved by Faculty,org-admin,admin)','57':'User Request VM(Approved by Faculty and Rejected by org-admin)','58':'User Request VM(Approved by Faculty,org-admin and Rejected by admin)','59':'User Request VM(Rejected by Faculty )','101':'Performance Testing(1CPU,80GB HDD,256MB RAM)','102':'Performance Testing(1CPU,80GB HDD,512MB RAM)','103':'Performance Testing(1CPU,80GB HDD,1GB RAM)','104':'Performance Testing(1CPU,80GB HDD,2GB RAM)','105':'Performance Testing(2CPU,80GB HDD,2GB RAM)','106':'Performance Testing(2CPU,80GB HDD,4GB RAM)','107':'Performance Testing(4CPU,80GB HDD,4GB RAM)','108':'Performance Testing(4CPU,80GB HDD,8GB RAM)','109':'Performance Testing(8CPU,80GB HDD,8GB RAM)','110':'Performance Testing(8CPU,80GB HDD,16GB RAM)','111':'Performance Testing(16CPU,80GB HDD,16GB RAM)','112':'Performance Testing(1CPU,100GB HDD,256MB RAM)'}  
    if form.process().accepted:
        testcase_list=[]
        test_case_list=[]
        j=0
	    ...
	    if test_case_no == None :
                ...
                test_case_list.append(test_list[str(i)])
            j+=1
        print "test cases are : " + str(testcase_list)
